...
- Host can hide/show the room code to give the game board and scoreboard more room.
- Player join panel hides automatically once the game starts.
- Grab Bag answer reveals display as bold “Correct Options” separated by commas.
