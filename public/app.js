...
function renderHost() {
  ...
  if (state.stage === "round-intro") {
    ...
    $("hostQuestion").innerHTML = stageCard("round", title, state.round === "Final Round" && state.finalCategoryName ? state.finalCategoryName : "Press Next when you're ready.");
    $("hostAnswers").innerHTML = "";
...
function renderPlayer() {
  ...
  if (state.stage === "round-intro") {
    const title = state.round === "Final Round" ? "FINAL ROUND" : (state.round || "ROUND").toUpperCase();
    $("playerQuestion").innerHTML = stageCard("round", title, state.round === "Final Round" && state.finalCategoryName ? state.finalCategoryName : "");
    $("playerAnswers").innerHTML = "";
